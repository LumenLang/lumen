...
```luma
set gui to new inventory "punishments" with size 27 titled "<red><b>Punish Player"
```

You can also use rows instead of raw size:

```luma
set gui to new inventory "punishments" with rows 3 titled "<red><b>Punish Player"
```

Without a title:

```luma
set gui to new inventory "storage" with rows 6
```
...
```luma
set filler to new item gray_stained_glass_pane
...
set free to get first empty slot of gui
...
register inventory "warp_menu":
    set gui to new inventory "warp_menu" with rows 3 titled "<dark_aqua><b>Warp Menu"
    ...
    set spawn_icon to new item ender_pearl
    ...
    set nether_icon to new item magma_cream
    ...
    set end_icon to new item ender_eye
...
register inventory "punish":
    set gui to new inventory "punish" with rows 5 titled "<red><b>Moderation"

    set border to new item red_stained_glass_pane
    set border's name to " "
    fill slots 0 to 8 of gui with border
    fill slots 36 to 44 of gui with border

    set mute_btn to new item paper
    ...
    set kick_btn to new item iron_door
    ...
    set ban_btn to new item barrier
    ...
    set close_btn to new item arrow
