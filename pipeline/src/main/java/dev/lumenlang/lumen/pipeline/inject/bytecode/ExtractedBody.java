 ...
 */
public record ExtractedBody(@NotNull InsnList instructions, @NotNull List<FakeBinding> fakeBindings, @NotNull String sourceClass, @NotNull String returnDescriptor, int maxStack, int maxLocals) {
     ...
     * @param fakeMethodName the fake method that was called (e.g. "fakeVar", "fakeInt")
     * @param returnDescriptor the return type descriptor of the fake method
     */
    public record FakeBinding(@NotNull String bindingName, @NotNull String fakeMethodName, @NotNull String returnDescriptor) {
    }
}
