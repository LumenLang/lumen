...
import net.vansencool.lumen.pipeline.language.LumenCore;
 ...
 *
 * <p>A {@code Pattern} is the result of calling {@link LumenCore#compile(String)}
 ...
 * @see PatternPart
 * @see LumenCore#compile(String)
 * @see LumenCore#match(List, Pattern, TypeRegistry, TypeEnv)
 */
