...
public final class InjectableHandlerFactoryImpl implements InjectableHandlers.Factory {
    ...
    @Override
    public @NotNull StatementHandler statement(@NotNull InjectableBody body) {
        return new InjectableStatementHandler(body);
    }

    @Override
    public @NotNull StatementHandler statement(@NotNull Class<?> clazz, @NotNull String methodName) {
        return new InjectableStatementHandler(clazz, methodName);
    }
