 ...
 */
public record ExtractedBody(@NotNull InsnList instructions, @NotNull List<FakeBinding> fakeBindings, @NotNull List<TryCatchBlockNode> tryCatchBlocks, @NotNull String sourceClass, @NotNull String returnDescriptor, int maxStack, int maxLocals) {
