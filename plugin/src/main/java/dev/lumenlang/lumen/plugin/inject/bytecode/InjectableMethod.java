 ...
 */
public record InjectableMethod(@NotNull String methodName, @NotNull String returnType,
                               @NotNull List<String> parameterTypes, @NotNull List<String> parameterBindings,
                               @NotNull ExtractedBody extractedBody) {
}
