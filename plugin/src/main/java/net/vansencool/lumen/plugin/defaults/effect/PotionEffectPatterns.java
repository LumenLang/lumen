package net.vansencool.lumen.plugin.defaults.effect;
...
/**
 * Registers potion effect statement and condition patterns.
 *
 * <p>Provides the ability to apply, remove, and clear potion effects on
 * players and living entities, as well as conditions for checking active effects.
 */
@Registration
@Description("Registers potion effect patterns: apply, remove, clear effects, and has-effect conditions")
@SuppressWarnings("unused")
public final class PotionEffectPatterns {
